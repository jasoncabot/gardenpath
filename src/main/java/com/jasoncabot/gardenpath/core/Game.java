...
public class Game {
    ...
    public Game(final long id, final State state, final Instant lastMoveAt, final PrivateInfo info, final boolean isMyTurn, final Player me, final Player you) {
        this.id = id;
        this.me = me;
        this.you = you;
        this.state = state;
    ...
    public void validateMove(final int end) throws GameException {
    ...
    public void validateFence(final Fence fence) throws GameException {
        if (!(getState() == State.IN_PROGRESS)) {
